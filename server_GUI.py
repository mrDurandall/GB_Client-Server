# import PyQt5
import sys
from PyQt5.QtWidgets import QMainWindow, QDialog, qApp, QApplication, QAction, QLabel, QTableView, QPushButton
...
def create_stat_model(database):
    ...
    list.setHorizontalHeaderLabels(
        ['Имя Клиента', 'Сообщений отправлено', 'Сообщений получено'])
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.active_clients_table.setFixedSize(1260, 650)
